...
void ThrowConnectingSocketNetworkEvent(int32_t, int32_t, int32_t, int32_t, char*, bool);
...
double networkSendUDPHelper(int32_t, char*, int32_t, int32_t, int32_t, bool, void *);
