...
void CSkeletonInstance::CSkeletonInstance(void *);
void CSkeletonSprite::CSkeletonSprite(char*, int32_t);
void CSkeletonSprite::CSkeletonSprite(char*, uint32_t, uint32_t, uint32_t, void *);
...
bool CSkeletonSprite::LoadFromFile(char*, char*);
bool CSkeletonSprite::LoadFromFileAsync(char*, char*, int32_t);
