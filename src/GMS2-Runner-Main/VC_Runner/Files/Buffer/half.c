...
/* type 0x620 */ IBuffer::Compress(int32_t, int32_t, void *);
...
int32_t IBuffer::CopyMemoryToMemory(/* type 0x620 */, int32_t, /* type 0x620 */, int32_t, int32_t, int32_t, int32_t, bool, bool);
/* type 0x620 */ IBuffer::Decompress(void *);
...
int32_t IBuffer::WriteArray(/* type 0x7ded (LF_ENUM) */, /* type 0x620 */, int32_t);
