...
uint8_t* IBuffer::Compress(int32_t, int32_t, void *);
...
int32_t IBuffer::CopyMemoryToMemory(uint8_t*, int32_t,uint8_t*, int32_t, int32_t, int32_t, int32_t, bool, bool);
uint8_t* IBuffer::Decompress(void *);
...
int32_t IBuffer::WriteArray(/* type 0x7ded (LF_ENUM) */,uint8_t*, int32_t);
