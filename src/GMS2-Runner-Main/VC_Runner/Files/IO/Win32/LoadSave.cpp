...
bool LoadSave::_FileExists(/* type 0x670 */);
int32_t LoadSave::_GetBundleFileName(/* type 0x670 */, int32_t, void *);
int32_t LoadSave::_GetSaveFileName(/* type 0x670 */, int32_t, void *);
void _LogInetError(/* type 0x22 */, void *, void *);
/* type 0x670 */ LoadSave::_ReadFile(void *, /* type 0x675 */);
