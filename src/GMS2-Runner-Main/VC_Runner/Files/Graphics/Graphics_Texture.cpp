...
int32_t GR_Texture_Create(/* type 0x620 */, uint32_t, bool, bool);
int32_t GR_Texture_Create_And_Fill(int32_t, int32_t, /* type 0x620 */, uint32_t, /* type 0x72fd (LF_ENUM) */, /* type 0x7362 (LF_ENUM) */);
...
int32_t GR_Texture_Create_From_File(/* type 0x620 */, uint32_t);
...
bool TextureGroupInfo_Load(/* type 0x620 */, uint32_t, /* type 0x620 */);
