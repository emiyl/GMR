...
// Original path : D:\a\GameMaker\GameMaker\GameMaker\Runner\GMS2-Runner-Main\VC_Runner\Android\jni\libpng\pngwutil.c
...
void png_do_write_interlace(void *, uint8_t*, int32_t);
int32_t png_text_compress(void *, char*, /* type 0x23 */, int32_t, void *);
void png_write_IDAT(void *, uint8_t*, /* type 0x23 */);
...
void png_write_chunk(void *, uint8_t*, uint8_t*, /* type 0x23 */);
void png_write_chunk_data(void *, uint8_t*, /* type 0x23 */);
void png_write_chunk_end(void *);
void png_write_chunk_start(void *, uint8_t*, uint32_t);
void png_write_filtered_row(void *, uint8_t*);
...
void png_write_tRNS(void *, uint8_t*, void *, int32_t, int32_t);
