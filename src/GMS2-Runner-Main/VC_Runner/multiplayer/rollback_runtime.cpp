...
/* type 0x620 */ Rollback::GMSessionListener::allocate_buffer(uint32_t);
void std::_Tree<std::_Tmap_traits<int,int,std::less<int>,std::allocator<std::pair<int const ,int> >,0> >::clear(void);
bool Rollback::GMSessionListener::compress_game_state(/* type 0x620 */, uint32_t, void *, void *);
bool Rollback::GMSessionListener::decompress_game_state(/* type 0x620 */, uint32_t, void *, void *);
/* type 0x23 */ std::_Tree<std::_Tmap_traits<int,int,std::less<int>,std::allocator<std::pair<int const ,int> >,0> >::erase(void *);
void Rollback::GMSessionListener::free_buffer(/* type 0x620 */);
bool Rollback::GMSessionListener::is_ready_to_start(void);
bool Rollback::GMSessionListener::load_game_state(/* type 0x620 */, int32_t, /* type 0x620 */, int32_t);
bool Rollback::GMSessionListener::log_game_state(void *, /* type 0x620 */, int32_t);
bool Rollback::GMSessionListener::log_game_state_diff(/* type 0x620 */, int32_t, /* type 0x620 */, int32_t);
void Rollback::log_game_state_summary(/* type 0x620 */, int32_t);
